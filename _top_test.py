...
from entsoe_repo.entsoe import EntsoeRawClient

import json
import ppm.globals as glob
from ppm.globals import SUB_GOOGLE, SUB_LAND
...
date = pd.Timestamp('20190712', tz='Europe/Brussels')
...
xml_string = client.query_generation_units(country_code, imp_date=date, psr_type=None)

# &documentType=A95
# &businessType=B11
# &biddingZone_Domain=10YGB----------A
# &implementation_DateAndOrTime=2018-07-12

# GET /api?documentType=A95&businessType=B11&biddingZone_Domain=10YCZ-CEPS-----N&implementation_DateAndOrTime=2017-01-01

file_spec = glob.set_path('nl_generation_units01.xml', SUB_LAND)
